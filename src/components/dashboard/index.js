...
export default class Dashboard extends React.Component {
    ...
    render() {
        ...
        if (this.state.location === 'campus-1') {
            ...
            return <GenericLandscapeDashboard lang={lang} locationId={this.state.location} building="campus" floor="1" location="Campus - Floor 1" />;
        } else if (this.state.location === 'campus-2') {
            BodyClass.addClassToBody('landscape campus-2');
            return <GenericLandscapeDashboard lang={lang} locationId={this.state.location} building="campus" floor="2" location="Campus - Floor 2" />;
        } else if (this.state.location === 'fronthouse') {
            BodyClass.addClassToBody('landscape fronthouse');
            return <FrontHouseDashboard lang={lang} locationId={this.state.location} building="front" location="Front House" />;
        } else {
            BodyClass.addClassToBody('portrait entrance');
            return <NotmanEntranceDashboard lang={lang} locationId={this.state.location} building="front" location="Front House" />;
        }
    }
}
