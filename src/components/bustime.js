...
export default class Bustime extends React.Component {
    ...
    getNextBusTime() {
        ...
        fetchJsonp(fetchUrl)
            ...
            .then((data) => {
                ...
                scope.setState({nextBusTime: nextBusTime, minutesToBus: minutesToBus});
    ...
    componentWillMount() {
        this.setState({busline: this.props.businfo.busline, direction: this.props.businfo.direction, busStopCode: this.props.businfo.busStopCode, nextBusTime: [], minutesToBus: []});
    }
